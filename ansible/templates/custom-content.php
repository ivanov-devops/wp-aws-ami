...
echo "Namespaces are a fundamental aspect of containers on Linux.";

echo "\n";

echo "The term 'namespace' is often used for a type of namespace (e.g. process ID) as well for a particular space of names.";

echo "\n";

echo "A Linux system starts out with a single namespace of each type, used by all processes. Processes can create additional namespaces and join different namespaces.";
